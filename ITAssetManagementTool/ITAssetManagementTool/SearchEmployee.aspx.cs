...
namespace ITAssetManagementTool
{
    public partial class SearchEmployee : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string checkSerialno = "SELECT * FROM AllotAssetTable WHERE Emp_ID='" + TextBoxEmpID.Text + "'";
            ...
            if (dr.Read())
            {
                ...
                TextBox4.Text = (dr["Asset_Type"].ToString());
                TextBox5.Text = (dr["Asset_Serial_No"].ToString());
